 ...
 */
public class LireIndexingThread extends Thread {
     ...
     * @param parent
     */
    public LireIndexingThread(String path, String rootPath) {
        this.imagePath = path;
        this.indexPath = createIndexPath(rootPath);
    }

    private String createIndexPath(String rootPath) {
    ...
    public void run() {
    	//Delete existing indexes in indexPath
    	purgeIndexes();
...
//            ParallelIndexer indexer = new ParallelIndexer(images, builder);
            ...
            // TODO set the number of threads to 8 instead of 1
            net.semanticmetadata.lire.indexing.parallel.ParallelIndexer pin =
                    new net.semanticmetadata.lire.indexing.parallel.ParallelIndexer(8, indexPath, imagePath, create){
                        @Override
                        public void addBuilders(ChainedDocumentBuilder builder) {
                        	//System.out.println("add Builder from GUI");
...
//            iw.close();
    ...
    {
    	System.out.println("Dans LIREDemo");
